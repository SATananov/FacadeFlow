...
- the ring has an outer contour and an inner glazing contour;
- each 45-degree mitre seam stays inside the profile band by joining corresponding outer/inner corners;
- opening geometry remains anchored to the sash/glazing contour;
- no production profile face, cut size or machine geometry is inferred.

Geometry, topology, FIELD semantics and Profile Resolution remain unchanged.
MACHINE READY: NO.
