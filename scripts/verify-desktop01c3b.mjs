...
if (pkg.version !== '0.1.2') fail(`package version must be 0.1.2; found ${pkg.version}`)
if (lock.version !== '0.1.2' || lock.packages?.['']?.version !== '0.1.2') fail('package-lock root version must be 0.1.2')
if (!appVersion.includes("APP_VERSION = '0.1.2'")) fail('visible APP_VERSION must be 0.1.2')
...
console.log('SOURCE VERSION: 0.1.2')
console.log('VISIBLE VERSION: 0.1.2')
