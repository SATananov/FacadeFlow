...
assert.match(app, /не създава\s+автоматично делители, крила или геометрия/)
assert.match(app, /не определя начин на отваряне/)
...
console.log('OPENING DIRECTION: NOT YET IMPLEMENTED')
