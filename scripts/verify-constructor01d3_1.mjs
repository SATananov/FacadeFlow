...
assert.match(shellCss, /height: 124px/)
assert.match(shellCss, /flex: 0 0 208px/)
assert.match(shellCss, /min-width: 208px/)
...
assert.match(shellCss, /bottom: 152px/)
assert.match(shellCss, /inset: 24px 0 152px 28px/)
