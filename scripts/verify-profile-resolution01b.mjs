...
assert.match(semanticsData, /profileCode: '482\.18'[\s\S]*visibleFace:[\s\S]*valueMm: 56/)
assert.match(semanticsData, /not an automatic joint overlap/)
assert.match(semanticsData, /glazing inset, glass cut or machining rule/)
...
console.log('482.05 + 482.18 SASH VISIBLE FACE: 56 mm REVIEWED')
console.log('SASH OVERLAP / GLAZING INSET: UNKNOWN')
