...
assert.match(shell, /FACADEFLOW CONSTRUCTOR · (?:CONSTRUCTOR 01[BC]|FIELD TOPOLOGY 01C\.[12]|FRAME INTERIOR 01C\.3|FIELD TOPOLOGY 01C\.3\.2)/)
...
assert.match(shell, /(?:Constructor 01C|FIELD TOPOLOGY 01C\.[12]|FRAME INTERIOR 01C\.3|FIELD TOPOLOGY 01C\.3\.2)/)
